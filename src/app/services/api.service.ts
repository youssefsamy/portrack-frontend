...
export class Api {
  ...
  createAuthorizationHeader() {
    if (this.settings.getStorage('token')) {
      return new HttpHeaders().set(
        'Authorization',
        'JWT ' + this.settings.getStorage('token')
      );
    } else {
  ...
  get(url, data?) {
    ...
    return this.http
      .get(this.settings.apiUrl + url, {
        headers: headers,
        params: data
      })
      .map(res => res)
      .catch((error: any) => this.handleError(this, error));
  ...
  post(url, data) {
    const headers = this.createAuthorizationHeader();
    return this.http
      .post(this.settings.apiUrl + url, data, {
        headers
      })
      .map(res => res)
      .catch((error: any) => this.handleError(this, error));
  ...
  put(url, data) {
    ...
    return this.http
      .put(this.settings.apiUrl + url, data, {
        headers: headers
      })
      .map(res => res)
      .catch((error: any) => this.handleError(this, error));
  ...
  delete(url) {
    const headers = this.createAuthorizationHeader();
    return this.http
      .delete(this.settings.apiUrl + url, {
        headers: headers
      })
      .map(res => res)
      .catch((error: any) => this.handleError(this, error));
