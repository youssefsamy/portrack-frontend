...
export class ClientApi extends Api {
  ...
  public getFISSecurityDetailByISIN(isin) {
    return this.get('/fis/securities/isin/', {
      isin: isin
    });
  }
  ...
  public listFileDocuments() {
    return this.get('/fms/documents/');
  }
  ...
  public getHoldingDeatail(id) {
    return this.get('/pms/holdings/' + id + '/');
  }

  public registerOrganization(data) {
    return this.post('/ums/register/', data);
  }

  public getCountries() {
    return this.get('/generic/countries/');
  }

  public createUsers(data) {
    return this.post('/ums/users/', data);
  }

  public getClientUsers() {
    return this.get('/ums/users/clients/');
  }

  public getClientDetail(clientId) {
    return this.get(`/pms/clients/${clientId}`);
  }

  public getOperatorUsers() {
    return this.get('/ums/users/operators/');
  }

  public getOperatorDetail(operatorId) {
    return this.get(`/pms/operators/${operatorId}/`);
  }

  public getUserDetail(userId) {
    return this.get(`/ums/users/${userId}/`);
  }

  public listAssignableOperators() {
    return this.get('/ums/users/assignable_operators');
  }

  public createClientAccount(data) {
    return this.post(`/pms/accounts/`, data);
  }

  public getClientAccountDetail(accountId) {
    return this.get(`/pms/accounts/${accountId}/`);
  }

  public updateClientAccountDetail(accountId, data) {
    return this.put(`/pms/accounts/${accountId}/`, data);
  }

  public updateUser(id, data) {
    return this.put('/ums/users/' + id + '/', data);
  }
}
