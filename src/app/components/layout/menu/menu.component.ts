...
export class MenuComponent {
  clientMenuItems = [
    ...
    },
    {
      ...
      subMenus: [
        {
          name: 'Privacy Policy',
          routerName: 'privacy-policy'
        },
        {
          name: 'Terms & Conditions',
          routerName: 'terms-conditions'
        }
      ]
    }
  ];
  operatorMenuItems = [
    ...
    },
    {
      ...
      subMenus: [
        ...
        {
          name: 'Portrack',
          routerName: 'operator/portfolio/client-list'
        },
        {
          name: 'Client Orders',
          routerName: 'operator/portfolio/waiting-orders'
        },
        {
          name: 'My Prospects',
  ...
  constructor(public setting: SettingsService, public router: Router) {}
