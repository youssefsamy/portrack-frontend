...
@Component({
    selector: 'page-editdeposit-transaction',
    templateUrl: './editdeposit.component.html',
    styleUrls: ['./editdeposit.component.scss']
})
export class OperatorEditDepositTransactionComponent implements OnInit {
    ...
    getTransaction() {
        this.api.getTransaction(this.transactionId).subscribe(res => {
            ...
            if (res['maturity_at']) this.form.controls['maturity_at'].setValue(res['maturity_at'].substr(0, 10));
