...
@Component({
    selector: 'page-editsecurity-transaction',
    templateUrl: './editsecurity.component.html',
    styleUrls: ['./editsecurity.component.scss']
})
export class OperatorEditSecurityTransactionComponent implements OnInit {
    ...
    getTransaction() {
        this.api.getTransaction(this.transactionId).subscribe(res => {
            ...
            this.form.controls['is_sell'].setValue(res['is_sell']);
